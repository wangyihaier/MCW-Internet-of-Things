...
![Create Time Series Insights Submit](images/02_Create_Time_Series_Inisghts_Submit_New.png)
...
![Create Event Source Submit](images/04_Create_Event_Source_Submit_New.png)
...
![Visualize Data](images/10_visual10_New.png)

Select Events and split by Device ID and click on perspective image.

![Visualize Data](images/11_visual11_New.png)
...
![Visualize Data](images/predicate_New.png)

Perspective with 4 different charts and also changed Title

![Visualize Data](images/14_Visual_dashboard_New.png)

Click on Heatmap

![Visualize Data](images/heatmap_New.png)

View data in a table

![Visualize Data](images/table_New.png)
